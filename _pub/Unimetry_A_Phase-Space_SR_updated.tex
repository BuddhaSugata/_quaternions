...
\small
\begin{verbatim}
q --(d1)--> d1 q d1 --(d2)--> d2 d1 q d1 d2
          |                         |
          +-- pull back by \bar d_{12} -----+--> r_W q r_W^{-1}
\end{verbatim}
\end{minipage}
\caption{Schematic: two successive D-rotations (boosts) and compensation of the net
spatio--temporal angle by the conjugate of $d_{12}$, leaving a pure R-rotation $r_W$.}
\label{fig:ascii-wigner-pullback}
\end{figure}
